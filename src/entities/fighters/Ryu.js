...
export class Ryu extends Fighter {
  constructor (x, y, direction, playerId) {
    ...
    this.frames = new Map([
      ...
      // Jump Up
      ['jump-up-1', [[[67, 244, 56, 104], [32, 107]], PushBox.IDLE]],
      ['jump-up-2', [[[138, 233, 50, 89], [25, 103]], PushBox.IDLE]],
      ['jump-up-3', [[[197, 233, 54, 77], [25, 103]], PushBox.IDLE]],
      ['jump-up-4', [[[259, 240, 48, 70], [28, 101]], PushBox.IDLE]],
      ['jump-up-5', [[[319, 234, 48, 89], [25, 106]], PushBox.IDLE]],
      ['jump-up-6', [[[375, 244, 55, 109], [31, 113]], PushBox.IDLE]],

      // Jump Forwards/Backwards
      ['jump-roll-1', [[[67, 244, 56, 104], [25, 106]], PushBox.JUMP]],
    ...
    this.animations = {
      ...
      [FigterState.CROUCH]: [['crouch-3', FrameDelay.FREEZE]],

...
import { FrameDelay, FigterState, PushBox } from './../../contants/fighter'
...
export class Ken extends Fighter {
  constructor (x, y, direction, playerId) {
    ...
    this.frames = new Map([
      ...
      ['forwards-3', [[[140, 866, 63, 90], [35, 87]], PushBox.IDLE]],
      ...
      ['jump-roll-1', [[[1237, 1037, 56, 103], [25, 106]], PushBox.JUMP]],
      ...
      // Jump Up
      ['jump-up-1', [[[724, 1036, 56, 104], [32, 107]], PushBox.IDLE]],
      ['jump-up-2', [[[792, 995, 50, 89], [25, 103]], PushBox.IDLE]],
      ['jump-up-3', [[[853, 967, 54, 77], [25, 103]], PushBox.IDLE]],
      ['jump-up-4', [[[911, 966, 48, 70], [28, 101]], PushBox.IDLE]],
      ['jump-up-5', [[[975, 977, 48, 86], [25, 101]], PushBox.IDLE]],
      ['jump-up-6', [[[1031, 1008, 55, 103], [32, 107]], PushBox.IDLE]],
      ...
      ['crouch-turn-2', [[[424, 882, 52, 61], [27, 58]], PushBox.CROUCH]],
    ...
    this.animations = {
      ...
      [FigterState.JUMP_LAND]: [
        ['jump-land', 33], ['jump-land', 177], ['jump-land', FrameDelay.TRANSITION]
      ],
      [FigterState.CROUCH]: 6[['crouch-3', FrameDelay.FREEZE]],
    ...
    this.initialVelocity = {
      x: {
        [FigterState.WALK_FORWARD]: 3 * 60,
        [FigterState.WALK_BACKWARD]: -(3 * 60),
        [FigterState.JUMP_FORWARD]: ((48 * 3) + (12 * 2)),
        [FigterState.JUMP_BACKWARD]: -((45 * 4) + (15 * 3))
      },
      jump: -420
    }
